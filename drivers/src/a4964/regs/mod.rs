...
mod tests {
    ...
    fn test_default_values() {
        ...
        assert_eq!(regs[A4964Reg::Pwm0].value(), 0b0_0010_0110);
        assert_eq!(regs[A4964Reg::Pwm1].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::Bridge].value(), 0b0_0010_0000);
        assert_eq!(regs[A4964Reg::GateDrive0].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::GateDrive1].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::GateDrive2].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::CurrentLimit].value(), 0b0_0111_1111);
        assert_eq!(regs[A4964Reg::VdsMonitor0].value(), 0b0_0001_1111);
        assert_eq!(regs[A4964Reg::VdsMonitor1].value(), 0b0_0011_1111);
        assert_eq!(regs[A4964Reg::Watchdog0].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::Watchdog1].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::Commutation0].value(), 0b0_0111_0111);
        assert_eq!(regs[A4964Reg::Commutation1].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::Bemf0].value(), 0b0_0000_0100);
        assert_eq!(regs[A4964Reg::Bemf1].value(), 0b0_0000_0001);
        assert_eq!(regs[A4964Reg::Startup0].value(), 0b0_0010_0101);
        assert_eq!(regs[A4964Reg::Startup1].value(), 0b0_0001_1100);
        assert_eq!(regs[A4964Reg::Startup2].value(), 0b0_0010_0111);
        assert_eq!(regs[A4964Reg::Startup3].value(), 0b0_0111_0111);
        assert_eq!(regs[A4964Reg::Startup4].value(), 0b0_0111_0111);
        assert_eq!(regs[A4964Reg::Startup5].value(), 0b0_0100_0111);
        assert_eq!(regs[A4964Reg::SpeedLoop0].value(), 0b0_0101_0101);
        assert_eq!(regs[A4964Reg::SpeedLoop1].value(), 0b0_1000_0000);
        assert_eq!(regs[A4964Reg::SpeedLoop2].value(), 0b0_0111_0111);
        assert_eq!(regs[A4964Reg::NvmWrite].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::System].value(), 0b1_0100_0000);
        assert_eq!(regs[A4964Reg::PhaseAdvance].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::MotorFunction].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::Mask].value(), 0b1_0000_0000);
        assert_eq!(regs[A4964Reg::ReadbackSelect].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::ReadOnly].value(), 0b0_0000_0000);
        assert_eq!(regs[A4964Reg::WriteOnly].value(), 0b0_0000_0000);
    }
}
